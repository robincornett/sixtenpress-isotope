 ...
 * @type {string}
 */
var bowerSource = 'bower_components';
 ...
 */
var SixTenSource = [
	bowerSource + '/sixtenpress/includes/common/**.*',
	bowerSource + '/sixtenpress/includes/common/**/*'
];
 ...
 * @type {{projectName: string, version: string, paths: {sassPath: string, bowerDir: string, sixten: string}, output: {style: string, destination: string}, destination: string, buildInclude: [*]}}
 */
module.exports = {
